...
def __getattr__(name):
    ...
    if name in _TMM_EXPORTS:
        from . import tmm
        if name == "tmm_dbcm_to_npm":
            return tmm.dbcm_to_npm
        if name == "tmm_npm_to_dbcm":
            return tmm.npm_to_dbcm
        return getattr(tmm, name)
...
__all__ = [
    ...
    # Transfer/scattering matrix API
    "TransferMatrix",
    "ScatteringMatrix",
    "Cascade",
    "tmm_dbcm_to_npm",
